...
export const sellerCycle = createAsyncThunk('seller-async-calls', async (formData, thunkApi) => {
    try {
        const res = await axios.post('https://crackers-distribution-ecommerce-app.vercel.app/product-api/editproducts', formData, {
            headers: {
...
export const deleteProduct = createAsyncThunk(
    ...
    async (product, thunkAPI) => {
        try {
            const res = await axios.delete('https://crackers-distribution-ecommerce-app.vercel.app/product-api/deleteproducts', {
