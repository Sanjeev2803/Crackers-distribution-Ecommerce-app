...
export const fetchCartItems = createAsyncThunk(
  ...
  async (product, thunkAPI) => {
    try {
      const response = await axios.put(`https://www.crackers-distribution-ecommerce-9xccotwk0.vercel.app/user-api/users`,product);
...
export const removeCartItem = createAsyncThunk(
  ...
  async (items, thunkAPI) => {
    try {
      const res=await axios.delete(`https://www.crackers-distribution-ecommerce-9xccotwk0.vercel.app/user-api/cart`,{ data: items });
