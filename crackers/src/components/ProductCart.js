...
const [unsavedChanges, setUnsavedChanges] = useState(false);
  ...
  const handlePayment = async (e) => {
    ...
    const res = await axios.post('https://crackers-distribution-ecommerce-9xccotwk0.vercel.app/user-api/payment', order);
    ...
    let options = {
      ...
      handler:async function(response){
        ...
        const validate= await axios.post('https://crackers-distribution-ecommerce-9xccotwk0.vercel.app/user-api/orderValidate',body)
  ...
  const handleSaveChanges = async () => {
    ...
    if (confirmChanges) {
      try {
        ...
        const response = await axios.put('https://crackers-distribution-ecommerce-9xccotwk0.vercel.app/user-api/afterChangeCartQuantity', { cartItems: localCartItems,FirstName:currentUserFirstName });
