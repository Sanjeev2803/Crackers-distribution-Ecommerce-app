...
console.log(oldproductdata)
  ...
  const productEdit = async(newProduct) => {
    ...
    const formdata = new FormData();
      ...
      try {
        let res = await axios.post('https://crackers-distribution-ecommerce-pgnljzoow.vercel.app/product-api/sellerEdit', formdata, {
          headers: {
      ...
      try {
        ...
        let res = await axios.post('https://crackers-distribution-ecommerce-pgnljzoow.vercel.app/product-api/urlNochangeEdit', sellerspecificProduct);
        console.log(res.data);
      } catch (error) {
        console.log(error.message);
      }
